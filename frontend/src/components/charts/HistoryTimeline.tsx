...
const HistoryTimeline: React.FC<HistoryTimelineProps> = ({ history, onRefresh }) => {
  ...
  const layout = useMemo(() => ({
    title: {
      text: '<b>Prediction History Timeline</b>',
      font: { size: 20 }
    },
    xaxis: {
      title: 'Timestamp',
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="mt-6 grid grid-cols-4 gap-4">
        <div className="bg-blue-50 p-4 rounded-lg text-center">
          <p className="text-sm text-blue-800 font-semibold">Total Predictions</p>
